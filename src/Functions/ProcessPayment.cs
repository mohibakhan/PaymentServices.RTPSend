...
///     dead-lettered for manual investigation.
/// </summary>
public class ProcessPayment
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // RTPSend now only owns ACCOUNTLOOKUP → call Gateway /tptch/send. If the
        // Gateway call fails (GatewayCallException) or any other error occurs, it
        // bubbles up: SB increments delivery count and DLQs after MaxDeliveryCount.
        // The downstream pipeline outcome arrives later via HandlePaymentOutcome.
